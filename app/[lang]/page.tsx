      ...
      <section className="py-16 bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <AnimatedStatCounter value={99.7} suffix="%" label={t('stats.uptime')} />
            <AnimatedStatCounter value={5} label={t('stats.sensors')} />
            <AnimatedStatCounter value={3} label={t('stats.industries')} />
          ...
          <div className="bg-white/95 backdrop-blur-md rounded-2xl p-8 md:p-12 shadow-2xl">
            ...
            <div className="mt-8 pt-8 border-t border-gray-200">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <a href={t('footer.contact.phoneLink')} className="flex items-center gap-2 text-cyan-600 hover:text-cyan-700 font-semibold transition-colors">
