...
export default function AnimatedHero({ children, className = "" }: AnimatedHeroProps) {
  ...
  const particleCount = isMobile ? 2 : 5; // Reduce particles on mobile
  ...
  return (
    <div className={`relative ${className}`}>
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className={`absolute inset-0 tech-grid-background ${isMobile ? 'opacity-20' : 'opacity-30'}`}></div>
        ...
        {/* Layer 4: Floating Particles (5 on desktop, 2 on mobile) */}
